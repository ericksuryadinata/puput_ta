<div class='with-right-sidebar' id='primary'> 
    <div class='column dt-sc-one-column blog-fullwidth with-sidebar'>
        <article class='blog-entry single format-image'>
            <a href='{{route('kerja-sama.detail',['slug' => $post->kerja_sama_slug])}}' class='title'>
                <h2>{{$post->kerja_sama_judul}}</h2>
            </a>
            <p>{{tgl_indo($post->created_at,'berita')}}</p>
            <p>Dibaca: <b>{{$post->kerja_sama_views}}</b> kali</p>
            <div class='section'>    
            ...
            <div class='entry-body'>
                <div class='entry-details'>
                    <p>
                        <img src='{{base_url(image_path_for('kerja_sama','large').$post->kerja_sama_gambar)}}'>
                    </p>
                    <p>&nbsp;</p>
