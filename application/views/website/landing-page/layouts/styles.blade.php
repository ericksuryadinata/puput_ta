<link id="default-css" rel="stylesheet" href="{{base_url('assets/website/style.css')}}" type="text/css">
...
<link rel="stylesheet" id="rs-plugin-settings-css"  href="{{base_url('assets/website/css/settings.css')}}" type="text/css" media="all" />
