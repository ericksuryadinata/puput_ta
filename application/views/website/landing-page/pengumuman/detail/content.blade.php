<div class='with-right-sidebar' id='primary'> 
    <div class='column dt-sc-one-column blog-fullwidth with-sidebar'>
        <article class='blog-entry single format-image'>
            <a href='{{route('pengumuman.detail',['slug' => $post->pengumuman_slug])}}' class='title'>
                <h2>{{$post->pengumuman_judul}}</h2>
            </a>
            <p>{{tgl_indo($post->created_at,'berita')}}</p>
            <p>Dibaca: <b>{{$post->pengumuman_views}}</b> kali</p>
            <div class='section'>    
            ...
            <div class='entry-body'>
                <div class='entry-details'>
                    <p>
                        <img src='{{base_url(image_path_for('pengumuman','extra').$post->pengumuman_gambar)}}'>
                    </p>
                    <p>&nbsp;</p>
