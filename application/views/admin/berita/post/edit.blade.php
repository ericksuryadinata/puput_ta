    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <?php echo form_open_multipart(route('admin.dosen.update'),'id="form_validation" novalidate="novalidate"')?>
                        <div class="header">
                            <h2>EDIT DOSEN</h2>
                        </div>
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                    ...
                                    <div>
                                        <img id="targetphoto" src="{{$placeholder}}" alt="profilphoto" height="200" width="150" style="object-fit:contain">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <textarea name="aktifitas" id="aktifitas">
                                        {{isset($dosen->aktifitas) ? $dosen->aktifitas : ''}}
                                    </textarea>
                                </div>
                            </div>
                            ...
                            <input type="text" class="hidden" name="id" value="{{isset($dosen->id) ? $dosen->id : ''}}">
