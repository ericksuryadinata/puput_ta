    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <?php echo form_open(route('admin.berita.kategori.save'),'id="form_validation" novalidate="novalidate"')?>
                        <div class="header">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="nama_kategori" required="" aria-required="true">
                                </div>
                            </div>
