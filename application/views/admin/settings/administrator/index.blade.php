...
<section class="content">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb breadcrumb-col-teal">
            ...
            <li><a class="active" href="#">Administrator</a></li>
        </ol>
        </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        ...
                        <br>
                        <a href="{{route('admin.settings.administrator.create')}}" class="btn bg-indigo waves-effect">Tambah Data</a>
...
@section('additional-scripts')
    ...
    $(document).ready(function () {
        ...
        table = $('#partner-list').DataTable({
            ...
            ajax: {
                url: '{{route("admin.settings.administrator.datatable")}}',
                type: 'GET',
        ...
        $('.js-basic-example').on('click','.hapus', function () {
            ...
            $.ajax({
                type: "POST",
                url: '{{route("admin.settings.administrator.delete")}}',
        ...
        $('.js-basic-example').on('click','.aktifkan',function () {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('admin.settings.administrator.aktifkan')}}",
                data: csrf,
                dataType: "JSON",
                success: function (response) {
                    if(response.message === 'success'){
