    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <?php echo form_open_multipart(route('admin.kerja-sama.save'),'id="form_validation" novalidate="novalidate"')?>
                        <div class="header">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="judul_kerja_sama" required="" aria-required="true">
                                </div>
                            </div>
                            <label for="email_address">Isi Kerja Sama</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <textarea name="isi_kerja_sama" id="isi_kerja_sama"></textarea>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
