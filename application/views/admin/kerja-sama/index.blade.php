...
<section class="content">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb breadcrumb-col-teal">
            ...
            <li><a class="active" href="#">Kerja Sama</a></li>
        </ol>
        </div>
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>LIST KERJA SAMA</h2>
                        <br>
                        <a href="{{route('admin.kerja-sama.create')}}" class="btn bg-indigo waves-effect">Tambah Data</a>
                        <a href="javascript:void(0)" class="btn bg-green waves-effect" id="refresh">Refresh</a>
                    </div>
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="kerja-sama-list">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Gambar</th>
...
@section('additional-scripts')
    ...
    $(document).ready(function () {
        ...
        table = $('#kerja-sama-list').DataTable({
            serverSide: true,
            responsive:true,
            order: [],
            lengthMenu: [[10, 25, 50, 100, -1], [10, 25, 50, 100, "All"]],
            ajax: {
                url: '{{route("admin.kerja-sama.datatable")}}',
                type: 'GET',
        ...
        $('.js-basic-example').on('click','.hapus', function () {
            ...
            $.ajax({
                type: "POST",
                url: '{{route("admin.kerja-sama.delete")}}',
